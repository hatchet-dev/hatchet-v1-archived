...
func (c *provisionerClient) GetStateUpdate(ctx context.Context, in *ModuleRun, opts ...grpc.CallOption) (Provisioner_GetStateUpdateClient, error) {
...
func (c *provisionerClient) GetLog(ctx context.Context, in *ModuleRun, opts ...grpc.CallOption) (Provisioner_GetLogClient, error) {
...
func (UnimplementedProvisionerServer) GetStateUpdate(*ModuleRun, Provisioner_GetStateUpdateServer) error {
	return status.Errorf(codes.Unimplemented, "method GetStateUpdate not implemented")
}
func (UnimplementedProvisionerServer) GetLog(*ModuleRun, Provisioner_GetLogServer) error {
